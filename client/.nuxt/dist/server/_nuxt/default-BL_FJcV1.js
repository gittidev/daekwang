import { capitalize, h, camelize, ref, readonly, inject, computed, reactive, shallowRef, provide, createVNode, TransitionGroup, Transition, toRefs, isRef, mergeProps, toRef, watch, nextTick, withDirectives, Fragment, resolveDirective, vShow, watchEffect, unref, Text, resolveDynamicComponent, toRaw, onScopeDispose, defineComponent as defineComponent$1, withCtx, createBlock, openBlock, renderList, toDisplayString, createTextVNode, useSSRContext, renderSlot } from "vue";
import { ssrRenderComponent, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderSlot } from "vue/server-renderer";
...
import { h as includes, p as propsFactory, j as genericComponent, k as getCurrentInstance, t as templateRef, l as convertToUnit, m as findChildrenWithProvide, n as getUid, o as provideDefaults, q as destructComputed, s as isCssColor, v as isParsableColor, w as parseColor, x as getForeground, y as getCurrentInstanceName, z as makeThemeProps, A as provideTheme, B as useRtl, C as clamp, D as useProxiedModel, E as useToggleScope, F as deepEqual, G as wrapInArray, H as consoleWarn, I as useIcon, J as IconValue, K as flattenFragments, L as hasEvent, M as isObject, N as keyCodes, O as breakpoints, P as consoleError, Q as defineComponent, R as EventProp, S as deprecate, T as focusChild, U as getPropertyFromItem, V as isPrimitive, W as omit, X as defer, Y as useDisplay, Z as makeDisplayProps, _ as _export_sfc, u as useRuntimeConfig } from "../server.mjs";
import { _ as _sfc_main$4 } from "./NuxtImg-B1SZBIN_.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VAppBar, {
        ...
        flat: "",
        color: "#2e2e2e",
        class: "px-6 text-white elevation-2"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VContainer, { class: "d-flex justify-space-between align-center" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="d-flex align-center cursor-pointer" style="${ssrRenderStyle({ "flex-shrink": "0" })}" data-v-148116d4${_scopeId2}><img${ssrRenderAttr("src", _imports_0)} alt="Logo" style="${ssrRenderStyle({ "height": "20px" })}" data-v-148116d4${_scopeId2}><h1 class="ml-3 text-xl font-weight-bold text-white" data-v-148116d4${_scopeId2}>대광PC</h1></div>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        ssrRenderList(navItems, (item) => {
                          _push4(`<span class="mx-3 text-white text-body-2 font-weight-medium hover:text-orange-accent-2 transition cursor-pointer" data-v-148116d4${_scopeId3}>${ssrInterpolate(item.label)}</span>`);
                        });
                        _push4(`<!--]-->`);
                      } else {
                        return [
                          (openBlock(), createBlock(Fragment, null, renderList(navItems, (item) => {
                            return createVNode("span", {
                              ...
                              onClick: ($event) => navigate(item.to)
                  ...
                  return [
                    createVNode("div", {
                      ...
                      createVNode("h1", { class: "ml-3 text-xl font-weight-bold text-white" }, "대광PC")
                    ], 8, ["onClick"]),
            ...
            return [
              createVNode(VContainer, { class: "d-flex justify-space-between align-center" }, {
                default: withCtx(() => [
                  createVNode("div", {
                    class: "d-flex align-center cursor-pointer",
                    style: { "flex-shrink": "0" },
                ...
                if (_push3) {
                  ...
                  ssrRenderList(navItems, (item) => {
                    _push3(ssrRenderComponent(VListItem, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VListItemTitle, { class: "text-white font-weight-medium" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          return [
                            createVNode(VListItemTitle, { class: "text-white font-weight-medium" }, {
                              default: withCtx(() => [
                                createTextVNode(toDisplayString(item.label), 1)
                              ]),
                              _: 2
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-148116d4"]]);
const _sfc_main$2 = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
    const config = useRuntimeConfig();
    config.public.kakaoApiKey;
    ref(null);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtImg = _sfc_main$4;
      const _component_ClientOnly = __nuxt_component_1$1;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-2bbf8705><div class="contact-container" data-v-2bbf8705><div class="logo" data-v-2bbf8705>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/logo_line.svg",
        alt: "로고",
        width: "80px"
      }, null, _parent));
      _push(`<h1 data-v-2bbf8705>대광PC</h1></div><div class="contact-wrapper" data-v-2bbf8705><h2 class="contact-title" data-v-2bbf8705>CONTACT US</h2><div class="contact-content" data-v-2bbf8705><div data-v-2bbf8705><p data-v-2bbf8705><strong data-v-2bbf8705>전화:</strong> 010-2684-6408</p><p data-v-2bbf8705><strong data-v-2bbf8705>이메일:</strong> pyw4733@hanmail.net</p><p data-v-2bbf8705><strong data-v-2bbf8705>사업자 등록번호:</strong> 411-10-82273</p><p data-v-2bbf8705><strong data-v-2bbf8705>팩스:</strong> 062-961-6408</p><p data-v-2bbf8705><strong data-v-2bbf8705>주소:</strong> 광주광역시 광산구 사암로 340번길 30</p></div>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`</div></div></div><p class="license" data-v-2bbf8705>© 1994 대광PC. All Rights Reserved.</p></footer>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2bbf8705"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        style: {
          ...
          transform: `translate(-50%, -50%) scale(${cursorScale.value})`,
          backgroundColor: cursorColor.value,
          filter: cursorScale.value > 1 ? "blur(6px)" : "none"
        }
      }, _attrs))} data-v-2a0c37e7></div>`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Cursur.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2a0c37e7"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Cursur = __nuxt_component_2;
  _push(ssrRenderComponent(VApp, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<nav${_scopeId}>`);
        _push2(ssrRenderComponent(_component_CommonNavbar, null, null, _parent2, _scopeId));
        _push2(`</nav>`);
        ...
        _push2(`<footer${_scopeId}>`);
        _push2(ssrRenderComponent(_component_CommonFooter, null, null, _parent2, _scopeId));
        _push2(`</footer>`);
        _push2(ssrRenderComponent(_component_Cursur, null, null, _parent2, _scopeId));
      } else {
        return [
          createVNode("nav", null, [
            createVNode(_component_CommonNavbar)
          ]),
          ...
          createVNode("footer", null, [
            createVNode(_component_CommonFooter)
          ]),
          createVNode(_component_Cursur)
        ];
      }
    }),
    _: 3
...
//# sourceMappingURL=default-BL_FJcV1.js.map
